...
/* harmony import */ var _form_controller_ed77647a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-controller-ed77647a.js */ 7348);
...
/* harmony import */ var _dir_912e3e13_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dir-912e3e13.js */ 4996);
...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionInput = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionInput", 7);
    ...
    this.ionKnobMoveStart = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioB + step, 1);
      }
  ...
  activeBarStartChanged() {
    ...
    if (activeBarStart !== undefined) {
      if (activeBarStart > this.max) {
        (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`Range: The value of activeBarStart (${activeBarStart}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
        this.activeBarStart = this.max;
      } else if (activeBarStart < this.min) {
        (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`Range: The value of activeBarStart (${activeBarStart}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el);
  }
  componentDidLoad() {
  ...
  connectedCallback() {
    ...
    this.legacyFormController = (0,_form_controller_ed77647a_js__WEBPACK_IMPORTED_MODULE_3__.c)(el);
    this.updateRatio();
    ...
    this.contentEl = (0,_index_746a238e_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_746a238e_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    const rect = this.rect = this.rangeSlider.getBoundingClientRect();
    const currentX = detail.currentX;
    // figure out which knob they started closer to
    let ratio = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (currentX - rect.left) / rect.width, 1);
    if ((0,_dir_912e3e13_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el)) {
      ratio = 1 - ratio;
    }
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_746a238e_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
    this.update(detail.currentX);
    this.pressedKnob = undefined;
    this.emitValueChange();
  ...
  renderLegacyRange() {
    if (!this.hasLoggedDeprecationWarning) {
      (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`ion-range now requires providing a label with either the label slot or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the component or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`ion-range is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "end"
    }));
  }
  renderRange() {
    ...
    }, label !== undefined ? (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "label-text"
    }, label) : (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "label"
    })), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderRangeSlider() {
    ...
    let {
      labelText
    } = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.e)(el, rangeId);
    if (labelText === undefined || labelText === null) {
      labelText = inheritedAttributes['aria-label'];
    }
    let barStart = `${ratioLower * 100}%`;
    let barEnd = `${100 - ratioUpper * 100}%`;
    const rtl = (0,_dir_912e3e13_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
    ...
    }, ticks.map(tick => (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss,
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-range_entry_js.373aeb64f6425ade.js.map