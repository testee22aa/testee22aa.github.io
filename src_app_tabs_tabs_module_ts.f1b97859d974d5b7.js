...
const routes = [{
  ...
  children: [{
    ...
    path: 'ho-so',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_service_hoso_service_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_ho-so_ho-so_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../ho-so/ho-so.module */ 5112)).then(m => m.HoSoPageModule)
  }, {
    path: 'cai-dat',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_service_hoso_service_ts"), __webpack_require__.e("src_app_cai-dat_cai-dat_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../cai-dat/cai-dat.module */ 3444)).then(m => m.CaiDatPageModule)
  }, {
    path: 'dong-gop',
    loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_dong-gop_dong-gop_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../dong-gop/dong-gop.module */ 4660)).then(m => m.DongGopPageModule)
  }]
}, {
  path: '',
  redirectTo: '/t/ho-so',
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ 8848);
...
/* harmony import */ var _tabs_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs-routing.module */ 1395);
/* harmony import */ var _tabs_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tabs.page */ 5132);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 1124);
/* harmony import */ var _tabs_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs.page.html?ngResource */ 7276);
/* harmony import */ var _tabs_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tabs.page.scss?ngResource */ 5024);
...
let TabsPage = (_TabsPage = class TabsPage {
  constructor() {}
  ionViewWillEnter() {
    try {
...
}, _TabsPage.ctorParameters = () => [], _TabsPage);
...
//# sourceMappingURL=src_app_tabs_tabs_module_ts.f1b97859d974d5b7.js.map