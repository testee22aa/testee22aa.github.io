...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.setAria = (expanded = false) => {
       ...
       */
      const root = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          ...
          this.currentRaf = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.r)( /*#__PURE__*/(0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.r)( /*#__PURE__*/(0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.r)( /*#__PURE__*/(0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const waitForTransition = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_4__.c.get('animated', true);
      if (!animated) {
        return false;
      }
    ...
    this.updateState = /*#__PURE__*/(0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (initialUpdate = false) {
    ...
    this.disabled = false;
    this.readonly = false;
    this.toggleIcon = _index_ecfc2c9f_js__WEBPACK_IMPORTED_MODULE_3__.l;
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.a)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_2__.b)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
...
const AccordionGroup = class {
  ...
  valueChanged() {
    ...
    if (!multiple && Array.isArray(value)) {
       ...
       * Custom behavior: ['a', 'b']
       */
      (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`ion-accordion-group was passed an array of values, but multiple="false". This is incorrect usage and may result in unexpected behaviors. To dismiss this warning, pass a string to the "value" property when multiple="false".
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-accordion_2_entry_js.0684e981026aa3d8.js.map