...
/* harmony import */ var _config_96c9ace3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config-96c9ace3.js */ 1472);
/* harmony import */ var _button_active_b76ae4ec_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./button-active-b76ae4ec.js */ 6792);
...
/* harmony import */ var _overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-4565894b.js */ 1684);
/* harmony import */ var _theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-17531cdf.js */ 1468);
...
/* harmony import */ var _animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-a1d9e088.js */ 6684);
/* harmony import */ var _haptic_6447af60_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./haptic-6447af60.js */ 6468);
/* harmony import */ var _capacitor_b4979570_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./capacitor-b4979570.js */ 5128);
/* harmony import */ var _index_7a14ecec_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-7a14ecec.js */ 8060);
/* harmony import */ var _index_ff313b19_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./index-ff313b19.js */ 5384);
/* harmony import */ var _gesture_controller_0fa396c4_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./gesture-controller-0fa396c4.js */ 8536);
/* harmony import */ var _framework_delegate_aa433dea_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./framework-delegate-aa433dea.js */ 8024);
/* harmony import */ var _hardware_back_button_39299f84_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hardware-back-button-39299f84.js */ 9284);
/* harmony import */ var _index_595d62c9_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./index-595d62c9.js */ 724);
...
const iosEnterAnimation = baseEl => {
  ...
  const backdropAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_9__.c)();
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidPresent", 7);
    this.willPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillPresent", 7);
    this.willDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillDismiss", 7);
    this.didDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.d)(this);
    this.lockController = (0,_lock_controller_e8c6c051_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    this.triggerController = (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.e)();
    this.customHTMLEnabled = _ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_8__.c.get('innerHTMLTemplatesEnabled', _config_96c9ace3_js__WEBPACK_IMPORTED_MODULE_2__.E);
    this.processedInputs = [];
    this.processedButtons = [];
    this.presented = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.j)(this.el);
    this.triggerChanged();
  }
  componentWillLoad() {
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.k)(this.el);
    this.inputsChanged();
    this.buttonsChanged();
  }
  ...
  componentDidLoad() {
     ...
     */
    if (!this.gesture && (0,_ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_8__.b)(this) === 'ios' && this.wrapperEl) {
      this.gesture = (0,_button_active_b76ae4ec_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.wrapperEl, refEl => refEl.classList.contains('alert-button'));
  ...
  present() {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler, data);
        if (returnData === false) {
  ...
  renderCheckbox() {
    ...
    return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    }, inputs.map(i => (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
      ...
      tabIndex: i.tabindex,
      role: "checkbox",
      class: Object.assign(Object.assign({}, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_7__.g)(i.cssClass)), {
        'alert-tappable': true,
        'alert-checkbox': true,
    ...
    }, i.label)), mode === 'md' && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  renderRadio() {
    const inputs = this.processedInputs;
    if (inputs.length === 0) {
  ...
  renderInput() {
    ...
    return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      if (i.type === 'textarea') {
        ...
        }, (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", Object.assign({
          placeholder: i.placeholder,
          value: i.value,
          id: i.id,
          tabIndex: i.tabindex
        ...
        return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
          class: "alert-input-wrapper"
        }, (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", Object.assign({
          placeholder: i.placeholder,
          type: i.type,
          min: i.min,
          max: i.max,
  ...
  renderAlertButtons() {
    ...
    }, buttons.map(button => (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, button.htmlAttributes, {
      type: "button",
      id: button.id,
      class: buttonClass(button),
      tabIndex: 0,
      onClick: () => this.buttonClick(button)
    }), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("span", {
      class: "alert-button-inner"
    }, button.text), mode === 'md' && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  ...
  render() {
    ...
    return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        [mode]: true,
        'overlay-hidden': true,
      ...
      class: "alert-head"
    }, header && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: hdrId,
      class: "alert-title"
    }, header), subHeader && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: subHdrId,
      class: "alert-sub-title"
    }, subHeader)), this.renderAlertMessage(msgId), this.renderAlertInputs(), this.renderAlertButtons()), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
...
const inputClass = input => {
  ...
  }, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_7__.g)(input.cssClass)), (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_7__.g)(input.attributes ? (_c = input.attributes.class) === null || _c === void 0 ? void 0 : _c.toString() : ''));
};
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-alert_entry_js.a576a75ce41f55a4.js.map