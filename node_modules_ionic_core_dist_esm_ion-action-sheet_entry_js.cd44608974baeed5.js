...
/* harmony import */ var _button_active_b76ae4ec_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-b76ae4ec.js */ 6792);
...
/* harmony import */ var _overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-4565894b.js */ 1684);
...
/* harmony import */ var _animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./animation-a1d9e088.js */ 6684);
/* harmony import */ var _haptic_6447af60_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./haptic-6447af60.js */ 6468);
/* harmony import */ var _capacitor_b4979570_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./capacitor-b4979570.js */ 5128);
/* harmony import */ var _index_7a14ecec_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-7a14ecec.js */ 8060);
/* harmony import */ var _index_ff313b19_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-ff313b19.js */ 5384);
/* harmony import */ var _gesture_controller_0fa396c4_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./gesture-controller-0fa396c4.js */ 8536);
...
/* harmony import */ var _index_595d62c9_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./index-595d62c9.js */ 724);
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetDidPresent", 7);
    this.willPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetWillPresent", 7);
    this.willDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetWillDismiss", 7);
    this.didDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.d)(this);
    this.lockController = (0,_lock_controller_e8c6c051_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.triggerController = (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.e)();
    this.presented = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.i)(role)) {
  ...
  present() {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this3 = this;
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  callButtonHandler(button) {
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler);
        if (rtn === false) {
  ...
  connectedCallback() {
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_5__.k)(this.el);
  }
  componentDidLoad() {
    /**
    ...
    if (!this.gesture && (0,_ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' && wrapperEl && groupEl) {
      (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.e)(() => {
        const isScrollable = groupEl.scrollHeight > groupEl.clientHeight;
        if (!isScrollable) {
          this.gesture = (0,_button_active_b76ae4ec_js__WEBPACK_IMPORTED_MODULE_2__.c)(wrapperEl, refEl => refEl.classList.contains('action-sheet-button'));
  ...
  render() {
    ...
    }, header !== undefined && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: headerID,
      class: {
        'action-sheet-title': true,
        'action-sheet-has-sub-title': this.subHeader !== undefined
      }
    }, header, this.subHeader && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "action-sheet-sub-title"
    }, this.subHeader)), buttons.map(b => (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      id: b.id,
      class: buttonClass(b),
    ...
    }, b.icon && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      icon: b.icon,
      "aria-hidden": "true",
      lazy: false,
      class: "action-sheet-icon"
    }), b.text), mode === 'md' && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null)))), cancelButton && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "action-sheet-group action-sheet-group-cancel"
    }, (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, cancelButton.htmlAttributes, {
      type: "button",
      class: buttonClass(cancelButton),
      onClick: () => this.buttonClick(cancelButton)
    }), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("span", {
      class: "action-sheet-button-inner"
    }, cancelButton.icon && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      icon: cancelButton.icon,
      "aria-hidden": "true",
      lazy: false,
      class: "action-sheet-icon"
    }), cancelButton.text), mode === 'md' && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))))), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-action-sheet_entry_js.cd44608974baeed5.js.map