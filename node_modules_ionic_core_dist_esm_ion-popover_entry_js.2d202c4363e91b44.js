...
/* harmony import */ var _framework_delegate_aa433dea_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-aa433dea.js */ 8024);
/* harmony import */ var _helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-3379ba19.js */ 1888);
/* harmony import */ var _lock_controller_e8c6c051_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lock-controller-e8c6c051.js */ 8900);
/* harmony import */ var _index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-595d62c9.js */ 724);
/* harmony import */ var _overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-4565894b.js */ 1684);
/* harmony import */ var _ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ionic-global-9080266a.js */ 8428);
/* harmony import */ var _theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-17531cdf.js */ 1468);
/* harmony import */ var _index_01839411_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-01839411.js */ 3284);
/* harmony import */ var _animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-a1d9e088.js */ 6684);
/* harmony import */ var _hardware_back_button_39299f84_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hardware-back-button-39299f84.js */ 9284);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const wrapperAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const viewportAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
    ...
    this.coreDelegate = (0,_framework_delegate_aa433dea_js__WEBPACK_IMPORTED_MODULE_2__.C)();
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_5__.p)(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  connectedCallback() {
    ...
    (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
    ...
    if (parentPopover) {
      (0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  present(event) {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_aa433dea_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
       ...
       */
      if ((0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.m)(el)) {
        yield (0,_index_01839411_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_01839411_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this2.el, _this2.el);
      }
      unlock();
    })();
  }
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,G_HOAI_code_frontend_exceltoanki_soure_code_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const shouldDismiss = yield (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
        ...
        yield (0,_framework_delegate_aa433dea_js__WEBPACK_IMPORTED_MODULE_2__.d)(delegate, _this3.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_4565894b_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    const mode = (0,_ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
    const {
      onLifecycle,
      parentPopover,
      dismissOnSelect,
    ...
    const desktop = (0,_ionic_global_9080266a_js__WEBPACK_IMPORTED_MODULE_7__.a)('desktop');
    ...
    return (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.cssClass)), {
        [mode]: true,
    ...
    }), !parentPopover && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_adfb2000_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-popover_entry_js.2d202c4363e91b44.js.map